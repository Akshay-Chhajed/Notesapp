...
<html lang="en">
  ...
  <body>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 id="myModalLabel">
                    Sign up today  Start using our Online Notes App! 
                  </h4>
                  <h6>Password Should Include Capital letters,small letters,Numbers,Special Char</h6>
              </div>
              <div class="modal-body">
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>Developed  by  Tishma : A - 17 ,  Akshay : A - 21,  Aditya : A - 25 </p>
          </div>
      </div>
